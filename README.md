...
### 🔧 Premapriya D — Backend Developer
**Focus:** Firebase integration, Database operations, Business logic

| PR | Files | Description |
|----|-------|-------------|
| PR 2 | lib/services/auth_service.dart | Firebase Phone Auth (OTP send/verify) |
| PR 3 | lib/services/user_service.dart | User Firestore CRUD operations |
| PR 4 | lib/services/visitor_service.dart | Visitor Firestore CRUD + real-time streams |
| PR 5 | lib/services/fcm_service.dart | Push notifications setup |
| PR 6 | lib/providers/auth_provider.dart | Auth state management |
| PR 7 | lib/providers/visitor_provider.dart | Visitor state management |

---

### 🎨 Chaithanya — Frontend Developer
**Focus:** UI/UX design, Screen layouts, User interactions

| PR | Files | Description |
|----|-------|-------------|
| PR 8 | lib/screens/auth/ | Phone input, OTP verification, Role selection screens |
| PR 9 | lib/screens/guard/ | Guard dashboard, Add visitor form |
| PR 10 | lib/screens/resident/ | Resident dashboard (approve/deny) |
| PR 11 | lib/screens/admin/ | Admin dashboard (logs view) |
| PR 12 | lib/widgets/visitor_card.dart | Reusable visitor card widget |
| PR 13 | lib/screens/splash_screen.dart | Splash/loading screen |

---

### 🛠️ Shaswath K.G — Full Stack Developer
**Focus:** Data models, App configuration, Core utilities

| PR | Files | Description |
|----|-------|-------------|
| PR 14 | lib/models/user_model.dart | User data model |
| PR 15 | lib/models/visitor_model.dart | Visitor data model |
| PR 16 | lib/models/flat_model.dart | Flat data model |
| PR 17 | lib/core/constants/ | App constants, Firestore field names |
| PR 18 | lib/core/theme/ | App colors, Material theme |
| PR 19 | lib/core/routes/ | Route definitions, Navigation |
| PR 20 | lib/main.dart | Final app integration |
